...
<template>
  <VRow>
    ...
    <VCol cols="12" md="3">
      <VTextField 
        v-model="barang.diskon_nominal" label="Diskon Nominal" placeholder="Masukkan Dison Nominal" 
        :rules="[requiredValidator]"
        name="diskon_nominal" 
        @input="formatInput"
      />
    ...
    <VCol cols="12" md="3">
      <VBtn color="error" @click="deleteBarang(index)" class="mt-md-5">
        Delete
      </VBtn>
    </VCol>
    <VDivider />
