    ...
    <VCard class="pa-3" elevation="5">
      ...
      <VForm ref="refForm" @submit.prevent>
        <VRow>
          ...
          <VCol cols="12">
            <AppTextarea rows="1" v-model="cf.newRequest.alamat" label="Alamat(Wajib diisi)" placeholder="Alamat (wajib diisi)" auto-grow
          ...
          <VCol cols="12">
            <AppTextarea rows="1" v-model="cf.newRequest.no_hp" label="No Hp(Wajib diisi)" placeholder="No.Hp (wajib diisi)" auto-grow
              :rules="[requiredValidator]" />
          </VCol>
