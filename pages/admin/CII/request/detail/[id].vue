  ...
  <VRow class="mb-4">
    <VCol cols="12" md="6" class="mt-md-5">
      <VCard class="text-black">
        ...
        <VCardItem>
          <VBtn color="primary" @click="navigateTo(`/admin/cii/add/${surat._id}`)">Buat Surat Penawaran <VIcon size="28">tabler-truck</VIcon>
          </VBtn>
        </VCardItem>
      </VCard>
    </VCol>
...
try {
  ...
  // navigateTo('/admin/cii/request')
  console.log(error)
  throw createError({
    statusCode: error.code || 404,
    statusMessage: error.message || 'Request Tidak Ditemukan'
  })
}
