...
const deleteReview = async id => {
  await $aapi(`/apps/ecommerce/reviews/${id}`, { method: 'DELETE' })
        ...
        <VCardText>
          <div class="d-flex gap-6 flex-column flex-sm-row">
            ...
            <div class="flex-grow-1">
              <div v-for="(review, index) in reviewCardData" :key="index" class="d-flex align-center gap-x-4"
      ...
      <VCard>
        <VCardText>
          <div class="d-flex justify-space-between flex-sm-row flex-column">
            ...
            <div>
              <VueApexCharts id="shipment-statistics" type="bar" height="152" :options="reviewStatChartConfig"
    ...
    <VCol cols="12">
      <VCard>
        <VCardText>
          <div class="d-flex justify-space-between flex-wrap gap-6 ">
            ...
            <div class="d-flex flex-row gap-4 align-center flex-wrap">
              ...
              <AppSelect v-model="selectedStatus" style="max-inline-size: 7.5rem;min-inline-size: 7.5rem;" :items="[
                { title: 'All', value: 'All' },
                { title: 'Published', value: 'Published' },
                { title: 'Pending', value: 'Pending' },
              ]" />
              <VBtn prepend-icon="tabler-upload" variant="tonal" color="default">
                Export
              </VBtn>
            </div>
          </div>
        ...
        <VDataTableServer v-model:items-per-page="itemsPerPage" v-model:model-value="selectedRows" v-model:page="page"
          :headers="headers" :items="reviews" show-select :items-length="totalReviews" class="text-no-wrap"
            ...
            <div class="d-flex align-center gap-x-4">
              ...
              <div class="d-flex flex-column">
                <NuxtLink :to="{ name: 'apps-ecommerce-customer-details-id', params: { id: 478426 } }"
                  class="font-weight-medium" style="line-height: 1.375rem;">
                  {{ item.reviewer }}
                </NuxtLink>
                <div class="text-body-2">
                  {{ item.email }}
          ...
          <template #item.review="{ item }">
            <div class="my-4">
              <VRating readonly :model-value="item.review" size="24" class="mb-1" />
          ...
          <template #item.actions="{ item }">
            <IconBtn>
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem value="view" :to="{ name: 'apps-ecommerce-order-details-id', params: { id: item.id } }">
                    View
                  </VListItem>
